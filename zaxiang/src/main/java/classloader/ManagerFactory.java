...
import classloader.inter.BaseManager;
...
public class ManagerFactory {
    ...
    /** 要加载的类的 classpath */
    public static final String CLASS_PATH = "D:\\github\\mytest\\zaxiang\\target\\classes";

    /** 实现热加载的类的全名称(包名+类名 ) */
    public static final String MY_MANAGER = "classloader.inter.MyManager";
