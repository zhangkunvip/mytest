...
//                }
    ...
    static final class ChildOnlyClassLoader extends ClassLoader {
        ...
        protected Class<?> loadClass(String name, boolean resolve)
            ...
            try {
//                String uri = LoadedInChildClassLoader.class.getClass().getResource("/").getPath() + LoadedInChildClassLoader.class.getName() + ".class";
//                String xxx ="D:\\github\\mytest\\zaxiang\\target\\classes\\"+ LoadedInChildClassLoader.class.getTypeName()getName().getSimpleName() + ".class";
...
////                    resolveClass(c);
////                }
                Class<?> c = Class.forName(LoadedInChildClassLoader.class.getName());
                return c;
            } catch (Exception ex) {
    ...
    public static final class LoadedInChildClassLoader {
        ...
        static final byte[] moreBytesToLeak = new byte[1024 * 1024 * 600];
