...
public class HotItems {
    ...
    public static class WindowResultFunction implements WindowFunction<Long, ItemViewCount, Tuple, TimeWindow> {
         ...
         *
         * @param key             The key for which this window is evaluated.// 窗口的主键，即 itemId
         * @param window          The window that is being evaluated. // 窗口
         * @param aggregateResult The elements in the window being evaluated. // 聚合函数的结果，即 count 值
         * @param collector       A collector for emitting elements.// 输出类型为 ItemViewCount
